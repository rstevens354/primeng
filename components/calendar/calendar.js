...
var Calendar = /** @class */ (function () {
	...
	Object.defineProperty(Calendar.prototype, "bookedDates", {
        get: function () {
            return this._bookedDates;
        },
        set: function (bookedDates) {
            ...
            if (i == 0) {
                for (var j = (prevMonthDaysLength - firstDay + 1); j <= prevMonthDaysLength; j++) {
                    ...
                    week.push({
						...
						booked: this.isDateBooked(j, prev.month, prev.year, true)
					});
                }
                ...
                for (var j = 0; j < remainingDaysLength; j++) {
                    week.push({
                        ...
                        booked: this.isDateBooked(dayNo, month, year, false)
					});
                    dayNo++;
                }
            }
                ...
                for (var j = 0; j < 7; j++) {
                    if (dayNo > daysLength) {
                        ...
                        week.push({
							...
							booked: this.isDateBooked((dayNo - daysLength), next.month, next.year, true)
						});
                    }
                    else {
                        week.push({
	...
	Calendar.prototype.isDateBooked = function (day, month, year, otherMonth) {
    ...
    Calendar.prototype.isDateDisabled = function (day, month, year) {
	 ...
	 Calendar.prototype.isDateBooked = function (day, month, year) {
        if (this.bookedDates) {
            for (var _i = 0, _a = this.bookedDates; _i < _a.length; _i++) {
                var bookedDates = _a[_i];
                if (bookedDates.getFullYear() === year && bookedDates.getMonth() === month && bookedDates.getDate() === day) {
                    return true;
                }
            }
        }
    ...
    __decorate([
	 ...
	 __decorate([
        ...
        __metadata("design:type", Array),
        __metadata("design:paramtypes", [Array])
    ],  Calendar.prototype, "bookedDates", null);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Array),
        __metadata("design:paramtypes", [Array])
