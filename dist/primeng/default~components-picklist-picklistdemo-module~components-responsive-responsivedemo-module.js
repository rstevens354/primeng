...
var PickList = /** @class */ (function () {
    ...
    PickList.prototype.ngAfterViewChecked = function () {
        if (this.movedUp || this.movedDown) {
            var listItems = _dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].find(this.reorderedListElement, 'li.ui-state-highlight');
            var listItem = void 0;
            if (this.movedUp)
                listItem = listItems[0];
            else
                listItem = listItems[listItems.length - 1];
            _dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].scrollInView(this.reorderedListElement, listItem);
            this.movedUp = false;
    ...
    PickList.prototype.onFilter = function (event, data, listType) {
        ...
        if (listType === this.SOURCE_LIST) {
            ...
            this.visibleOptionsSource = _utils_objectutils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].filter(data, searchFields, this.filterValueSource);
            this.onSourceFilter.emit({ query: this.filterValueSource, value: this.visibleOptionsSource });
        }
        else if (listType === this.TARGET_LIST) {
            this.filterValueTarget = query;
            this.visibleOptionsTarget = _utils_objectutils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].filter(data, searchFields, this.filterValueTarget);
        ...
        if (this.onListItemDroppoint) {
            if (listType === this.SOURCE_LIST) {
                if (this.fromListType === this.TARGET_LIST) {
                    ...
                    _utils_objectutils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].reorderArray(this.source, this.draggedItemIndexSource, (this.draggedItemIndexSource > index) ? index : (index === 0) ? 0 : index - 1);
                ...
                if (this.fromListType === this.SOURCE_LIST) {
                    ...
                    _utils_objectutils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].reorderArray(this.target, this.draggedItemIndexTarget, (this.draggedItemIndexTarget > index) ? index : (index === 0) ? 0 : index - 1);
    ...
    PickList.prototype.findNextItem = function (item) {
        ...
        if (nextItem)
            return !_dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].hasClass(nextItem, 'ui-picklist-item') || _dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].isHidden(nextItem) ? this.findNextItem(nextItem) : nextItem;
        else
            return null;
    };
    PickList.prototype.findPrevItem = function (item) {
        ...
        if (prevItem)
            return !_dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].hasClass(prevItem, 'ui-picklist-item') || _dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].isHidden(prevItem) ? this.findPrevItem(prevItem) : prevItem;
        else
            return null;
    };
    __decorate([
...
var PickListModule = /** @class */ (function () {
    ...
    PickListModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            exports: [PickList, _common_shared__WEBPACK_IMPORTED_MODULE_3__["SharedModule"]],
...
//# sourceMappingURL=default~components-picklist-picklistdemo-module~components-responsive-responsivedemo-module.js.map