...
var OrderList = /** @class */ (function () {
    ...
    OrderList.prototype.ngAfterViewChecked = function () {
        if (this.movedUp || this.movedDown) {
            var listItems = _dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].find(this.listViewChild.nativeElement, 'li.ui-state-highlight');
            var listItem = void 0;
            if (listItems.length > 0) {
                ...
                _dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].scrollInView(this.listViewChild.nativeElement, listItem);
            }
            this.movedUp = false;
    ...
    OrderList.prototype.onItemClick = function (event, item, index) {
        ...
        var selectedIndex = _utils_objectutils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].findIndexInList(item, this.selection);
        ...
        if (metaSelection) {
            ...
            if (selected && metaKey) {
                ...
                _utils_objectutils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].insertIntoOrderedArray(item, index, this._selection, this.value);
            }
        }
        else {
            if (selected) {
    ...
    OrderList.prototype.filter = function () {
        ...
        this.visibleOptions = _utils_objectutils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].filter(this.value, searchFields, this.filterValue);
    };
    ...
    OrderList.prototype.isSelected = function (item) {
        return _utils_objectutils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].findIndexInList(item, this.selection) != -1;
    };
    OrderList.prototype.moveUp = function (event) {
        if (this.selection) {
            for (var i = 0; i < this.selection.length; i++) {
                var selectedItem = this.selection[i];
                var selectedItemIndex = _utils_objectutils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].findIndexInList(selectedItem, this.value);
    ...
    OrderList.prototype.onDrop = function (event, index) {
        ...
        _utils_objectutils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].reorderArray(this.value, this.draggedItemIndex, dropIndex);
        this.dragOverItemIndex = null;
        this.onReorder.emit(event);
        event.preventDefault();
    };
    ...
    OrderList.prototype.findNextItem = function (item) {
        ...
        if (nextItem)
            return !_dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].hasClass(nextItem, 'ui-orderlist-item') || _dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].isHidden(nextItem) ? this.findNextItem(nextItem) : nextItem;
        else
            return null;
    };
    OrderList.prototype.findPrevItem = function (item) {
        ...
        if (prevItem)
            return !_dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].hasClass(prevItem, 'ui-orderlist-item') || _dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].isHidden(prevItem) ? this.findPrevItem(prevItem) : prevItem;
        else
            return null;
    };
    __decorate([
...
//# sourceMappingURL=default~components-orderlist-orderlistdemo-module~components-responsive-responsivedemo-module.js.map