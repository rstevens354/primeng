...
var Messages = /** @class */ (function () {
    ...
    Messages = __decorate([
        ...
        __metadata("design:paramtypes", [_common_messageservice__WEBPACK_IMPORTED_MODULE_3__["MessageService"]])
    ], Messages);
    return Messages;
}());
...
var Password = /** @class */ (function () {
    ...
    Password.prototype.createPanel = function () {
        ...
        this.panel.style.minWidth = _dom_domhandler__WEBPACK_IMPORTED_MODULE_2__["DomHandler"].getOuterWidth(this.el.nativeElement) + 'px';
    ...
    Password.prototype.onFocus = function (e) {
        ...
        if (this.feedback) {
            ...
            this.zone.runOutsideAngular(function () {
                setTimeout(function () {
                    _dom_domhandler__WEBPACK_IMPORTED_MODULE_2__["DomHandler"].addClass(_this.panel, 'ui-password-panel-visible');
                    _dom_domhandler__WEBPACK_IMPORTED_MODULE_2__["DomHandler"].removeClass(_this.panel, 'ui-password-panel-hidden');
                }, 1);
                _dom_domhandler__WEBPACK_IMPORTED_MODULE_2__["DomHandler"].absolutePosition(_this.panel, _this.el.nativeElement);
            });
        }
    };
    Password.prototype.onBlur = function (e) {
        var _this = this;
        if (this.feedback) {
            _dom_domhandler__WEBPACK_IMPORTED_MODULE_2__["DomHandler"].addClass(this.panel, 'ui-password-panel-hidden');
            _dom_domhandler__WEBPACK_IMPORTED_MODULE_2__["DomHandler"].removeClass(this.panel, 'ui-password-panel-visible');
            this.zone.runOutsideAngular(function () {
                setTimeout(function () {
                    _this.ngOnDestroy();
                }, 150);
