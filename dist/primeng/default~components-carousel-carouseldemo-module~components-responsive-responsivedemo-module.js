...
var Carousel = /** @class */ (function () {
    ...
    Carousel.prototype.render = function () {
        ...
        this.items = _dom_domhandler__WEBPACK_IMPORTED_MODULE_1__["DomHandler"].find(this.itemsViewChild.nativeElement, 'li');
        this.calculateColumns();
        this.calculateItemWidths();
        this.setPage(Math.floor(this.firstVisible / this.columns), true);
        if (!this.responsive) {
            this.containerViewChild.nativeElement.style.width = (_dom_domhandler__WEBPACK_IMPORTED_MODULE_1__["DomHandler"].width(this.containerViewChild.nativeElement)) + 'px';
        }
        if (this.autoplayInterval) {
            this.circular = true;
            this.startAutoplay();
    ...
    Carousel.prototype.calculateItemWidths = function () {
        ...
        if (firstItem) {
            for (var i = 0; i < this.items.length; i++) {
                this.items[i].style.width = ((_dom_domhandler__WEBPACK_IMPORTED_MODULE_1__["DomHandler"].innerWidth(this.viewportViewChild.nativeElement) - (_dom_domhandler__WEBPACK_IMPORTED_MODULE_1__["DomHandler"].getHorizontalMargin(firstItem) * this.columns)) / this.columns) + 'px';
            }
        }
    };
    ...
    Carousel.prototype.setPage = function (p, enforce) {
        if (p !== this.page || enforce) {
            this.page = p;
            this.left = (-1 * (_dom_domhandler__WEBPACK_IMPORTED_MODULE_1__["DomHandler"].innerWidth(this.viewportViewChild.nativeElement) * this.page));
...
var CarouselModule = /** @class */ (function () {
    ...
    CarouselModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            exports: [Carousel, _common_shared__WEBPACK_IMPORTED_MODULE_2__["SharedModule"]],
...
//# sourceMappingURL=default~components-carousel-carouseldemo-module~components-responsive-responsivedemo-module.js.map