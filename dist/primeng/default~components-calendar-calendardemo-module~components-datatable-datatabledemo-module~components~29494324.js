(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~components-calendar-calendardemo-module~components-datatable-datatabledemo-module~components~29494324"],{
...
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.alignOverlay = function () {
        if (this.touchUI) {
            ...
            if (this.appendTo)
                _dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].absolutePosition(this.overlay, this.inputfieldViewChild.nativeElement);
            else
                _dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].relativePosition(this.overlay, this.inputfieldViewChild.nativeElement);
        }
    };
    ...
    Calendar.prototype.disableModality = function () {
        if (this.mask) {
            ...
            for (var i = 0; i < bodyChildren.length; i++) {
                ...
                if (_dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].hasClass(bodyChild, 'ui-datepicker-mask-scrollblocker')) {
    ...
    Calendar.prototype.isNavIconClicked = function (event) {
        return (_dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].hasClass(event.target, 'ui-datepicker-prev') || _dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].hasClass(event.target, 'ui-datepicker-prev-icon')
            || _dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].hasClass(event.target, 'ui-datepicker-next') || _dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].hasClass(event.target, 'ui-datepicker-next-icon'));
    };
    Calendar.prototype.onWindowResize = function () {
        if (this.overlayVisible && !_dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].isAndroid()) {
            this.hideOverlay();
        }
    };
...
var CalendarModule = /** @class */ (function () {
    ...
    CalendarModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _button_button__WEBPACK_IMPORTED_MODULE_3__["ButtonModule"], _common_shared__WEBPACK_IMPORTED_MODULE_5__["SharedModule"]],
            exports: [Calendar, _button_button__WEBPACK_IMPORTED_MODULE_3__["ButtonModule"], _common_shared__WEBPACK_IMPORTED_MODULE_5__["SharedModule"]],
...
//# sourceMappingURL=default~components-calendar-calendardemo-module~components-datatable-datatabledemo-module~components~29494324.js.map