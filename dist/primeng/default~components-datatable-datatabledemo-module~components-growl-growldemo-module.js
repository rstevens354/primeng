(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~components-datatable-datatabledemo-module~components-growl-growldemo-module"],{
...
var Growl = /** @class */ (function () {
    ...
    Growl.prototype.remove = function (index, msgel) {
        ...
        _dom_domhandler__WEBPACK_IMPORTED_MODULE_2__["DomHandler"].fadeOut(msgel, 250);
        setTimeout(function () {
    ...
    Growl.prototype.removeAll = function () {
        ...
        if (this.value && this.value.length) {
            _dom_domhandler__WEBPACK_IMPORTED_MODULE_2__["DomHandler"].fadeOut(this.containerViewChild.nativeElement, 250);
            setTimeout(function () {
    ...
    Growl = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["IterableDiffers"], _common_messageservice__WEBPACK_IMPORTED_MODULE_3__["MessageService"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"]])
    ], Growl);
    return Growl;
}());
...
//# sourceMappingURL=default~components-datatable-datatabledemo-module~components-growl-growldemo-module.js.map