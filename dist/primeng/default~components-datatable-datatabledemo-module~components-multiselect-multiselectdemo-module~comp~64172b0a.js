(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~components-datatable-datatabledemo-module~components-multiselect-multiselectdemo-module~comp~64172b0a"],{
...
var MultiSelect = /** @class */ (function () {
    ...
    Object.defineProperty(MultiSelect.prototype, "options", {
        ...
        set: function (val) {
            var opts = this.optionLabel ? _utils_objectutils__WEBPACK_IMPORTED_MODULE_4__["ObjectUtils"].generateSelectItems(val, this.optionLabel) : val;
    ...
    MultiSelect.prototype.findSelectionIndex = function (val) {
        ...
        if (this.value) {
            for (var i = 0; i < this.value.length; i++) {
                if (_utils_objectutils__WEBPACK_IMPORTED_MODULE_4__["ObjectUtils"].equals(this.value[i], val, this.dataKey)) {
                    index = i;
                    break;
                }
            }
    ...
    MultiSelect.prototype.onOverlayAnimationStart = function (event) {
        switch (event.toState) {
            case 'visible':
                ...
                this.appendOverlay();
                if (this.autoZIndex) {
                    this.overlay.style.zIndex = String(this.baseZIndex + (++_dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].zindex));
                }
                this.alignOverlay();
                this.bindDocumentClickListener();
    ...
    MultiSelect.prototype.appendOverlay = function () {
        if (this.appendTo) {
            if (this.appendTo === 'body')
                ...
                _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].appendChild(this.overlay, this.appendTo);
            this.overlay.style.minWidth = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getWidth(this.containerViewChild.nativeElement) + 'px';
        }
    };
    ...
    MultiSelect.prototype.alignOverlay = function () {
        if (this.overlay) {
            if (this.appendTo)
                _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].absolutePosition(this.overlay, this.containerViewChild.nativeElement);
            else
                _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].relativePosition(this.overlay, this.containerViewChild.nativeElement);
        }
    };
    ...
    MultiSelect.prototype.findNextItem = function (event) {
        ...
        if (nextItem)
            return _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].hasClass(nextItem.children[0], 'ui-state-disabled') || _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].isHidden(nextItem.children[0]) ? this.findNextItem(nextItem.children[0]) : nextItem.children[0];
        else
            return null;
    };
    MultiSelect.prototype.findPrevItem = function (event) {
        ...
        if (prevItem)
            return _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].hasClass(prevItem.children[0], 'ui-state-disabled') || _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].isHidden(prevItem) ? this.findPrevItem(prevItem.children[0]) : prevItem.children[0];
        else
            return null;
    };
    ...
    MultiSelect.prototype.findLabelByValue = function (val) {
        ...
        for (var i = 0; i < this.options.length; i++) {
            ...
            if (val == null && option.value == null || _utils_objectutils__WEBPACK_IMPORTED_MODULE_4__["ObjectUtils"].equals(val, option.value, this.dataKey)) {
                label = option.label;
                break;
            }
        }
    ...
    MultiSelect.prototype.activateFilter = function () {
        if (this.options && this.options.length) {
            ...
            this.visibleOptions = _utils_objectutils__WEBPACK_IMPORTED_MODULE_4__["ObjectUtils"].filter(this.options, searchFields, this.filterValue);
            this.filtered = true;
        }
    };
    ...
    MultiSelect.prototype.onWindowResize = function () {
        if (!_dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].isAndroid()) {
            this.hide();
        }
    };
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ContentChild"])(_common_shared__WEBPACK_IMPORTED_MODULE_5__["Footer"]),
        __metadata("design:type", Object)
...
var MultiSelectModule = /** @class */ (function () {
    ...
    MultiSelectModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _common_shared__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_7__["ScrollingModule"]],
            exports: [MultiSelect, _common_shared__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_7__["ScrollingModule"]],
...
//# sourceMappingURL=default~components-datatable-datatabledemo-module~components-multiselect-multiselectdemo-module~comp~64172b0a.js.map