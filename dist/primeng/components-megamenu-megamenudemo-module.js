...
var MegaMenu = /** @class */ (function () {
    ...
    MegaMenu.prototype.onItemMouseEnter = function (event, item, menuitem) {
        ...
        if (menuitem.items) {
            ...
            if (submenu) {
                if (this.autoZIndex) {
                    submenu.style.zIndex = String(this.baseZIndex + (++_dom_domhandler__WEBPACK_IMPORTED_MODULE_2__["DomHandler"].zindex));
                }
                if (this.orientation === 'horizontal') {
                    submenu.style.top = _dom_domhandler__WEBPACK_IMPORTED_MODULE_2__["DomHandler"].getOuterHeight(item.children[0]) + 'px';
                    submenu.style.left = '0px';
                }
                else if (this.orientation === 'vertical') {
                    submenu.style.top = '0px';
                    submenu.style.left = _dom_domhandler__WEBPACK_IMPORTED_MODULE_2__["DomHandler"].getOuterWidth(item.children[0]) + 'px';
                }
            }
        }
    };
...
var MegaMenuModule = /** @class */ (function () {
    ...
    MegaMenuModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            exports: [MegaMenu, _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"]],
...
/* harmony import */ var _megamenudemo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./megamenudemo */ "./src/app/showcase/components/megamenu/megamenudemo.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
        ...
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([
                    { path: '', component: _megamenudemo__WEBPACK_IMPORTED_MODULE_2__["MegaMenuDemo"] }
                ])
            ],
            exports: [
...
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _megamenudemo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./megamenudemo */ "./src/app/showcase/components/megamenu/megamenudemo.ts");
/* harmony import */ var _megamenudemo_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./megamenudemo-routing.module */ "./src/app/showcase/components/megamenu/megamenudemo-routing.module.ts");
/* harmony import */ var _components_megamenu_megamenu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../components/megamenu/megamenu */ "./src/app/components/megamenu/megamenu.ts");
    ...
    MegaMenuDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _megamenudemo_routing_module__WEBPACK_IMPORTED_MODULE_3__["MegaMenuDemoRoutingModule"],
                _components_megamenu_megamenu__WEBPACK_IMPORTED_MODULE_4__["MegaMenuModule"],
            ...
            declarations: [
                _megamenudemo__WEBPACK_IMPORTED_MODULE_2__["MegaMenuDemo"]
            ]
        })
    ], MegaMenuDemoModule);
...
var MegaMenuDemo = /** @class */ (function () {
    ...
    MegaMenuDemo = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            template: __webpack_require__(/*! ./megamenudemo.html */ "./src/app/showcase/components/megamenu/megamenudemo.html")
        })
    ], MegaMenuDemo);
    return MegaMenuDemo;
}());
...
//# sourceMappingURL=components-megamenu-megamenudemo-module.js.map