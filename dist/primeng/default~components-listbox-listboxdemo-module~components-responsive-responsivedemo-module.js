...
var Listbox = /** @class */ (function () {
    ...
    Listbox.prototype.removeOption = function (option) {
        var _this = this;
        this.value = this.value.filter(function (val) { return !_utils_objectutils__WEBPACK_IMPORTED_MODULE_4__["ObjectUtils"].equals(val, option.value, _this.dataKey); });
    };
        ...
        if (this.multiple) {
            if (this.value) {
                for (var _i = 0, _a = this.value; _i < _a.length; _i++) {
                    var val = _a[_i];
                    if (_utils_objectutils__WEBPACK_IMPORTED_MODULE_4__["ObjectUtils"].equals(val, option.value, this.dataKey)) {
                        selected = true;
                        break;
                    }
                }
            ...
            selected = _utils_objectutils__WEBPACK_IMPORTED_MODULE_4__["ObjectUtils"].equals(this.value, option.value, this.dataKey);
        }
        return selected;
    };
    ...
    Listbox.prototype.isItemVisible = function (option) {
        if (this.filterValue) {
            var visible = void 0;
            var filterText = _utils_objectutils__WEBPACK_IMPORTED_MODULE_4__["ObjectUtils"].removeAccents(this.filterValue).toLowerCase();
            switch (this.filterMode) {
                case 'startsWith':
                    visible = _utils_objectutils__WEBPACK_IMPORTED_MODULE_4__["ObjectUtils"].removeAccents(option.label).toLowerCase().indexOf(filterText) === 0;
                    break;
                case 'contains':
                    visible = _utils_objectutils__WEBPACK_IMPORTED_MODULE_4__["ObjectUtils"].removeAccents(option.label).toLowerCase().indexOf(filterText) > -1;
                    break;
                default:
                    visible = true;
            }
    ...
    Listbox.prototype.findNextItem = function (item) {
        ...
        if (nextItem)
            return _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].hasClass(nextItem, 'ui-state-disabled') || _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].isHidden(nextItem) ? this.findNextItem(nextItem) : nextItem;
        else
            return null;
    };
    Listbox.prototype.findPrevItem = function (item) {
        ...
        if (prevItem)
            return _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].hasClass(prevItem, 'ui-state-disabled') || _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].isHidden(prevItem) ? this.findPrevItem(prevItem) : prevItem;
        else
            return null;
    };
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('headerchkbox'),
...
//# sourceMappingURL=default~components-listbox-listboxdemo-module~components-responsive-responsivedemo-module.js.map