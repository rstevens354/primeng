(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~components-datagrid-datagriddemo-module~components-datalist-datalistdemo-module~components-d~b5e8be29"],{
...
var Dialog = /** @class */ (function () {
    ...
    Dialog.prototype.focus = function () {
        var focusable = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].findSingle(this.container, 'button');
        if (focusable) {
    ...
    Dialog.prototype.positionOverlay = function () {
        ...
        if (_dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(this.container) > viewport.height) {
    ...
    Dialog.prototype.center = function () {
        var elementWidth = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterWidth(this.container);
        var elementHeight = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(this.container);
        if (elementWidth == 0 && elementHeight == 0) {
            this.container.style.visibility = 'hidden';
            this.container.style.display = 'block';
            elementWidth = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterWidth(this.container);
            elementHeight = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(this.container);
        ...
        if (this.mask) {
            ...
            if (this.blockScroll) {
                ...
                for (var i = 0; i < bodyChildren.length; i++) {
                    ...
                    if (_dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].hasClass(bodyChild, 'ui-dialog-mask-scrollblocker')) {
    ...
    Dialog.prototype.maximize = function () {
        ...
        this.preMaximizeContainerWidth = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterWidth(this.container);
        this.preMaximizeContainerHeight = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(this.container);
        this.preMaximizeContentHeight = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(this.contentViewChild.nativeElement);
        ...
        if (this.headerViewChild && this.headerViewChild.nativeElement) {
            diffHeight += _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(this.headerViewChild.nativeElement);
        }
        if (this.footerViewChild && this.footerViewChild.nativeElement) {
            diffHeight += _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(this.footerViewChild.nativeElement);
        }
        this.contentViewChild.nativeElement.style.height = 'calc(100vh - ' + diffHeight + 'px)';
        _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].addClass(this.container, 'ui-dialog-maximized');
        _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].addClass(document.body, 'ui-overflow-hidden');
        this.moveOnTop();
        this.maximized = true;
    };
    Dialog.prototype.revertMaximize = function () {
        ...
        this.zone.runOutsideAngular(function () {
            setTimeout(function () { return _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].removeClass(_this.container, 'ui-dialog-maximized'); }, 300);
        });
    };
    ...
    Dialog.prototype.initDrag = function (event) {
        ...
        if (this.draggable) {
            ...
            _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].addClass(document.body, 'ui-unselectable-text');
        }
    };
    Dialog.prototype.getFocusableElements = function () {
        var focusableElements = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].find(this.container, "button:not([tabindex = \"-1\"]):not([disabled]):not([style*=\"display:none\"]):not([hidden]), \n                [href][clientHeight][clientWidth]:not([tabindex = \"-1\"]):not([disabled]):not([style*=\"display:none\"]):not([hidden]), \n                input:not([tabindex = \"-1\"]):not([disabled]):not([style*=\"display:none\"]):not([hidden]), select:not([tabindex = \"-1\"]):not([disabled]):not([style*=\"display:none\"]):not([hidden]), \n                textarea:not([tabindex = \"-1\"]):not([disabled]):not([style*=\"display:none\"]):not([hidden]), [tabIndex]:not([tabIndex = \"-1\"]):not([disabled]):not([style*=\"display:none\"]):not([hidden]), \n                [contenteditable]:not([tabIndex = \"-1\"]):not([disabled]):not([style*=\"display:none\"]):not([hidden])");
    ...
    Dialog.prototype.onDrag = function (event) {
        if (this.dragging) {
            var containerWidth = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterWidth(this.container);
            var containerHeight = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(this.container);
            var deltaX = event.pageX - this.lastPageX;
            var deltaY = event.pageY - this.lastPageY;
            var offset = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOffset(this.container);
    ...
    Dialog.prototype.endDrag = function (event) {
        if (this.draggable) {
            this.dragging = false;
            _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].removeClass(document.body, 'ui-unselectable-text');
        }
    };
    ...
    Dialog.prototype.onResize = function (event) {
        if (this.resizing) {
            ...
            var containerWidth = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterWidth(this.container);
            var containerHeight = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(this.container);
            var contentHeight = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(this.contentViewChild.nativeElement);
    ...
    Dialog.prototype.bindDocumentEscapeListener = function () {
        ...
        this.documentEscapeListener = this.renderer.listen('document', 'keydown', function (event) {
            if (event.which == 27) {
                if (parseInt(_this.container.style.zIndex) === (_dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].zindex + _this.baseZIndex)) {
                    _this.close(event);
                }
            }
        });
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ContentChildren"])(_common_shared__WEBPACK_IMPORTED_MODULE_4__["Header"], { descendants: false }),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["QueryList"])
    ], Dialog.prototype, "headerFacet", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ContentChildren"])(_common_shared__WEBPACK_IMPORTED_MODULE_4__["Footer"], { descendants: false }),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["QueryList"])
...
var DialogModule = /** @class */ (function () {
    ...
    DialogModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            exports: [Dialog, _common_shared__WEBPACK_IMPORTED_MODULE_4__["SharedModule"]],
            declarations: [Dialog]
        })
    ], DialogModule);
    return DialogModule;
...
//# sourceMappingURL=default~components-datagrid-datagriddemo-module~components-datalist-datalistdemo-module~components-d~b5e8be29.js.map